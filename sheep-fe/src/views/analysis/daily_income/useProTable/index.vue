...
import { getManuList, editManu, updateDailyIncome, exportSheepInfo, updateSelectDailyIncome } from "../api/manu";
...
const downloadFile = async () => {
  ElMessageBox.confirm("确认导出用户数据?", "温馨提示", { type: "warning" }).then(() =>
    useDownload(exportSheepInfo, "日收入报表导出结果", proTable.value?.searchParam)
  );
};
// 打开 drawer(新增、查看、编辑)
