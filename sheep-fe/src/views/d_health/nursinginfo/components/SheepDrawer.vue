        ...
        >
          ...
          <el-form-item label="生长形态" prop="testis_shape">
            <el-select v-model="drawerProps.row.testis_shape" clearable>
              <el-option v-for="item in d_healthTestis_shapeType" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="病斑颜色" prop="Ab_color">
            <el-select v-model="drawerProps.row.Ab_color" clearable>
              <el-option v-for="item in d_healthAb_colorType" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item label="病害气味特征" prop="Ab_smell">
            <el-select v-model="drawerProps.row.Ab_smell" clearable>
              <el-option v-for="item in d_healthAb_smellType" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
...
import { d_healthAb_colorType, d_healthAb_smellType, d_healthTestis_shapeType, BooleanType } from "@/assets/json/typeListJson";
