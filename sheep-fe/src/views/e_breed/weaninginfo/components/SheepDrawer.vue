    ...
    <div class="drawer-container">
      ...
      >
        ...
        >
          ...
          <el-form-item v-if="false" label="喂养方式" prop="feeding_way">
          ...
          <el-form-item label="阶段评级" prop="rank">
            <el-select v-model="drawerProps.row.rank" clearable>
              <el-option v-for="item in WeaningRankType" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
...
import { getManuList, getManuListNoneWeaning } from "../../weaninginfo/api/manu";
