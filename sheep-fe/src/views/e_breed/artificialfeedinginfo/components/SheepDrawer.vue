    ...
    <div class="drawer-container">
      ...
      >
        ...
        <el-input type="number" v-model="drawerProps.row.lamb_id" clearable></el-input>
          ...
          <!-- Feeding Material -->
          <el-form-item label="喂养物" prop="feeding_material">
          ...
          <!-- Feeding Staff -->
          <el-form-item label="喂养人员" prop="feeding_staff">
...
const rules = reactive({
  ...
  feeding_material: [{ required: true, message: "请填写喂养物" }],
  ...
  feeding_staff: [{ required: true, message: "请填写喂养人员" }]
});
