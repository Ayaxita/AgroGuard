<template>
  <button
    class="flex flex-row items-center gap-[2px] rounded-md border-[1px] px-[6px] py-[2px] backdrop-blur-md duration-500 hover:bg-black hover:bg-opacity-10"
  >
    <span class="sr-only">ModelSelector</span>
    <div>
    ...
    <div class="text-[10px] font-bold text-black text-opacity-90">
      <slot></slot>
    </div>
  </button>
</template>
