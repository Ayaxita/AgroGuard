...
d_plantcare = Blueprint('d_plantcare', __name__)


@d_plantcare.route('/d_plantcare/deathinfo', methods=['POST'])  # 绝收信息 后端接口
def get_deathinfo():
...
#卫生管理施药防治
@d_plantcare.route('/d_plantcare/immunizationinfo', methods=['POST'])
...
@d_plantcare.route('/d_plantcare/protectioninfo', methods=['POST'])  # 浸泡施药 后端接口
def get_drugbathinfo():
    ...
    search_params = {
        ...
        'drug_age': DPlantcareProtectioninfo.drug_age,
...
@d_plantcare.route('/d_plantcare/quarantineinfo', methods=['POST'])  # 检疫检验 后端接口
...
@d_plantcare.route('/d_plantcare/quarantineinfo/edit', methods=['POST'])  # 检验检疫 编辑 后端接口
...
@d_plantcare.route('/d_plantcare/nursinginfo', methods=['POST'])  # 护理信息 后端接口
def get_nursinginfo():
    pageNum = int(request.json.get('pageNum'))
    pageSize = int(request.json.get('pageSize'))
...
@d_plantcare.route('/d_plantcare/nursinginfo/edit', methods=['POST'])  # 护理信息 编辑 后端接口
...
@d_plantcare.route('/d_plantcare/diseaseinfo', methods=['POST'])  # 疾病信息 后端接口
def get_diseaseinfo():
    pageNum = int(request.json.get('pageNum'))
    pageSize = int(request.json.get('pageSize'))
...
@d_plantcare.route('/d_plantcare/damageinfo', methods=['POST'])  # 异常脱落信息 后端接口
...
@d_plantcare.route('/d_plantcare/immunizationinfo/add', methods=['POST'])  # 新增施药信息
...
@d_plantcare.route('/d_plantcare/protectioninfo/add', methods=['POST'])  # 新增浸泡施药信息
def add_drugbathinfo():
    ...
    if supplycommodityinfo and supplyvsuppliersinfo:
        ...
        return jsonify(result)
    drugbathinfo = DPlantcareProtectioninfo()
    for key, value in data.items():
...
@d_plantcare.route('/d_plantcare/quarantineinfo/add', methods=['POST'])  # 新增病虫害检测信息
...
@d_plantcare.route('/d_plantcare/nursinginfo/add', methods=['POST'])  # 新增护理信息
def add_nursinginfo():
    data = request.get_json()
    ctime = datetime.now()
    data['belong'] = 0
...
@d_plantcare.route('/d_plantcare/diseaseinfo/add', methods=['POST'])  # 新增疾病信息
def add_diseaseinfo():
    data = request.get_json()
    # ctime = datetime.now()
    data['belong'] = 0
...
@d_plantcare.route('/d_plantcare/damageinfo/add', methods=['POST'])  # 新增异常脱落记录
def add_abortioninfo():
    ...
    if query:
        ...
        return jsonify(result)
    abortioninfo = DPlantcareDamageinfo()
    for key, value in data.items():
...
@d_plantcare.route('/d_plantcare/deathinfo/edit', methods=['POST'])  # 绝收信息 编辑 后端接口
def edit_deathinfo():
    data = request.get_json()
    print("--data-->", data)
    # 这个表更新的话需要1个搜索条件
...
@d_plantcare.route('/d_plantcare/immunizationinfo/edit', methods=['POST'])  # 施药记录 编辑 后端接口
...
@d_plantcare.route('/d_plantcare/protectioninfo/edit', methods=['POST'])  # 药浴免疫 编辑 后端接口
...
@d_plantcare.route('/d_plantcare/diseaseinfo/edit', methods=['POST'])  # 疾病信息 编辑 后端接口
...
@d_plantcare.route('/d_plantcare/damageinfo/edit', methods=['POST'])  # 流产信息 编辑 后端接口
...
@d_plantcare.route('/d_plantcare/immunizationinfo/del', methods=['POST'])  # 接种免疫 编辑 后端接口
...
# 导出接种免疫
@d_plantcare.route('/d_plantcare/immunizationinfo/export', methods=['POST'])
def export_immunizationinfo():
    try:
        ...
        export_path = os.path.join(os.getcwd(), 'App', 'd_plantcare', 'export_excel', 'immunization_info.xlsx')
...
# 删除药浴免疫信息
@d_plantcare.route('/d_plantcare/protectioninfo/del', methods=['POST'])
...
# 导出药浴免疫
@d_plantcare.route('/d_plantcare/protectioninfo/export', methods=['POST'])
def export_drugbathinfo():
    try:
        ...
        export_path = os.path.join(os.getcwd(), 'App', 'd_plantcare', 'export_excel', 'drugbath_info.xlsx')
        df.to_excel(export_path, index=False)
...
# 删除检疫免疫信息
@d_plantcare.route('/d_plantcare/quarantineinfo/del', methods=['POST'])
...
# 导出检疫免疫
@d_plantcare.route('/d_plantcare/quarantineinfo/export', methods=['POST'])
def export_quarantineinfo():
    try:
        ...
        export_path = os.path.join(os.getcwd(), 'App', 'd_plantcare', 'export_excel', 'quarantine_info.xlsx')
        df.to_excel(export_path, index=False)
...
# 删除护理信息
@d_plantcare.route('/d_plantcare/nursinginfo/del', methods=['POST'])
def del_nursinginfo():
    ids = request.get_json()
    for i in ids:
...
@d_plantcare.route('/d_plantcare/nursinginfo/export', methods=['POST'])
def export_nursinginfo():
    try:
        ...
        for info, ele_num, pre_num in nursing_info:
            datatestis_shape = d_plantcareTestis_shapeType.get(info.testis_shape, " ")
        ...
        export_path = os.path.join(os.getcwd(), 'App', 'd_plantcare', 'export_excel', 'nursing_info.xlsx')
        df.to_excel(export_path, index=False)
...
@d_plantcare.route('/d_plantcare/diseaseinfo/del', methods=['POST'])
def del_diseaseinfo():
    ids = request.get_json()
    for i in ids:
...
@d_plantcare.route('/d_plantcare/diseaseinfo/export', methods=['POST'])
def export_diseaseinfo():
    try:
        ...
        export_path = os.path.join(os.getcwd(), 'App', 'd_plantcare', 'export_excel', 'disease_info.xlsx')
        df.to_excel(export_path, index=False)
...
# 删除流产信息
@d_plantcare.route('/d_plantcare/damageinfo/del', methods=['POST'])
...
# 删除流产信息
@d_plantcare.route('/d_plantcare/damageinfo/export', methods=['POST'])
def export_abortioninfo():
    try:
        ...
        export_path = os.path.join(os.getcwd(), 'App', 'd_plantcare', 'export_excel', 'abortion_info.xlsx')
        df.to_excel(export_path, index=False)
