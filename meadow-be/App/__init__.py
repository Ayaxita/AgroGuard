...
def create_app():
    ...
    # db_uri = 'mysql+pymysql://root:dpfxzby$ztcxlbj$9264$@39.99.175.254:8055/sheep_555'  # mysql链接
    # db_uri = 'mysql+pymysql://root:hscjtCemt2024$@182.92.207.3:3306/sheep_test' #mysql链接
    db_uri = 'mysql+pymysql://root:sheep123@mysql-db:3306/sheep_test' #mysql链接
