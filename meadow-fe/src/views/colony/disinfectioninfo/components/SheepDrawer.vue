    ...
    >
      ...
      <el-form-item label="防疫方法" prop="method">
        <el-select v-model="drawerProps.row.method" clearable>
          <el-option v-for="item in colonyDisinfectionMethodType" :key="item.value" :label="item.label" :value="item.value" />
        </el-select>
      </el-form-item>
...
import { colonyDisinfectionMethodType } from "@/assets/json/typeListJson";
