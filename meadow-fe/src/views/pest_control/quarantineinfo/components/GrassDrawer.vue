        ...
        >
          ...
          <el-form-item label="检测方式" prop="detection_mode">
            <el-select v-model="drawerProps.row.detection_mode" clearable>
              <el-option
                v-for="item in d_plantcareDetection_modeType"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              />
          ...
          <el-form-item label="监测结果1" prop="result1">
            <el-select v-model="drawerProps.row.result1" clearable>
              <el-option v-for="item in d_plantcareResult1Type" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item label="监测结果2" prop="result2">
            <el-select v-model="drawerProps.row.result2" clearable>
              <el-option v-for="item in d_plantcareResult2Type" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item label="监测结果3" prop="result3">
            <el-select v-model="drawerProps.row.result3" clearable>
              <el-option v-for="item in d_plantcareResult3Type" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item label="处理情况" prop="situation">
            <el-select v-model="drawerProps.row.situation" clearable>
              <el-option v-for="item in d_plantcareSituationType" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
