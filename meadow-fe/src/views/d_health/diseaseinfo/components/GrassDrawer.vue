        ...
        >
          ...
          <el-form-item label="治疗效果" prop="cur_effect">
            <el-select v-model="drawerProps.row.cur_effect" clearable>
              <el-option v-for="item in d_healthCur_effectType" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
...
import { d_healthCur_effectType, BooleanType } from "@/assets/json/typeListJson";
