<template>
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" :title="`${drawerProps.title}`" :size="drawerWidth">
    <div class="drawer-container">
      <div class="left-section" v-if="showSearch || showCname || showSupplyname">
      ...
      <div class="right-section" :style="{ right: drawerVisible ? `${drawerWidth}px` : '0px' }">
        ...
        >
          <el-form-item label="草地编号" prop="ele_num">
            <el-input v-model.number="drawerProps.row.ele_num" type="string" clearable />
          ...
          <el-form-item label="地块编号" prop="pre_num">
            <el-input v-model.number="drawerProps.row.pre_num" type="string" clearable />
          </el-form-item>
          ...
          <el-form-item label="操作" prop="operators">
            <el-input v-model="drawerProps.row.operators" type="textarea" clearable />
          </el-form-item>
          <el-form-item label="剂量" prop="dose"><el-input v-model="drawerProps.row.dose" clearable /></el-form-item>
          <el-form-item label="防护指数" prop="anti_level">
            <el-input v-model="drawerProps.row.anti_level" clearable />
          </el-form-item>
          <el-form-item label="后续监测" prop="post_stage">
            <el-input v-model="drawerProps.row.post_stage" clearable />
          </el-form-item>
...
const selectEwe = async (selectedList: any[]) => {
  ...
  drawerProps.value.row.pre_num = selectedList[0].pre_num;
...
const getTableList = (params: any) => getGrassList(normalize(params));
...
function changeImmdate() {
  drawerProps.value.row.imm_age = (getDaysDifference(selectedBirth, drawerProps.value.row.imm_date) / 30).toFixed(2);
}
