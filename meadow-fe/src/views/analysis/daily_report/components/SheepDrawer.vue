<template>
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="450px" :title="`${drawerProps.title}`">
    ...
    >
      ...
      <el-form-item v-if="activeIndex == '1'" label="种苗购买费用（元）" prop="buysheep_fees">
        <el-input v-model.number="drawerProps.row.buysheep_fees" type="number" step="0.01" clearable></el-input>
      </el-form-item>
