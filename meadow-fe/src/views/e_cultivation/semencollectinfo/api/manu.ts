...
export const getManuList = params => {
  const result = http.post(PORT1 + `/semencollectinfo`, params);
...
export const addManu = params => {
  return http.post(PORT1 + `/semencollectinfo/add`, params);
};

// 编辑记录
export const editManu = params => {
  return http.post(PORT1 + `/semencollectinfo/edit`, params);
};
// 删除记录
export const delManu = params => {
  return http.post(PORT1 + `/semencollectinfo/del`, params);
};
// 导出数据
