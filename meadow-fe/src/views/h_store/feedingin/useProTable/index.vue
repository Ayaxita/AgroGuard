...
import { FeedingTypeType, ingredientsType } from "@/assets/json/typeListJson";
...
const columns = reactive<ColumnProps<User.ResUserList>[]>([
  ...
  },
  {
    prop: "warehouse_num",
    label: "仓库",
    search: { el: "input", props: { type: "number" } }
  },
  {
    prop: "nutrients",
    label: "营养成分",
...
const downloadFile = async () => {
  ...
  //   useDownload(exportGrassInfo, "记录导出结果", proTable.value?.searchParam)
  // );
};
// 打开 drawer(新增、查看、编辑)
