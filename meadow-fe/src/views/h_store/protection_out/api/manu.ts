...
export const getManuList = params => {
  const result = http.post(PORT1 + `/protection_out`, params);
...
export const addManu = params => {
  return http.post(PORT1 + `/protection_out/add`, params);
};

// 编辑
export const editManu = params => {
  return http.post(PORT1 + `/protection_out/edit`, params);
};

// 删除
export const delManu = params => {
  return http.post(PORT1 + `/protection_out/del`, params);
};
