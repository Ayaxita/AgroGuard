...
import { getCutinfoList, editCutinfo, addCutinfo, delCutinfo } from "../api/manu";
import { colorType, harvestinfoWoolType, manutypeType, varietyType } from "@/assets/json/typeListJson";
...
const getTableList = (params: any) => {
  ...
  return getCutinfoList(newParams);
};
...
const openDrawer = (title: string, row: Partial<User.ResUserList> = {}) => {
  const params = {
    ...
    isView: title === "查看",
    row: { ...row },
    api: title === "新增" ? addCutinfo : title === "编辑" ? editCutinfo : undefined,
