...
import { getBreederConditionInfoList, getGoodsheep, getWith_births } from "../api/manu";
...
const getTableList = (params: any) => {
  ...
  console.log("getGoodsheep", getGoodsheep(newParams));
  return getGoodsheep(newParams);
};
