...
export const getManuList = params => {
  const result = http.post(PORT1 + `/growth_statusinfo`, params);
...
export const addManu = params => {
  return http.post(PORT1 + `/growth_statusinfo/add`, params);
};

// 编辑记录
export const editManu = params => {
  return http.post(PORT1 + `/growth_statusinfo/edit`, params);
};
// 删除记录
export const delManu = params => {
  return http.post(PORT1 + `/growth_statusinfo/del`, params);
};
// 导出数据
export const exportGrassInfo = params => {
  return http.download(PORT1 + `/growth_statusinfo/export`, params);
};
//获取监测目标信息
