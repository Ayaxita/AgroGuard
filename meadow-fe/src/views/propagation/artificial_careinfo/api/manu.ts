...
export const getManuList = params => {
  const result = http.post(PORT1 + `/artificial_careinfo`, params);
...
export const addManu = params => {
  return http.post(PORT1 + `/artificial_careinfo/add`, params);
};

// 编辑记录
export const editManu = params => {
  return http.post(PORT1 + `/artificial_careinfo/edit`, params);
};
// 删除记录
export const delManu = params => {
  return http.post(PORT1 + `/artificial_careinfo/del`, params);
};
// 导出数据
