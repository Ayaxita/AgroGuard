...
import { getEwe, getRam } from "../../post_harvestinfo/api/manu";
import { ColumnProps } from "@/components/ProTable/interface";
import { User } from "@/api/interface";
import { judgeInBreed } from "../api/manu";
import { getFemaleGrass } from "../../growth_statusinfo/api/manu";
import { getMaleGrass } from "../../sample_collectinfo/api/manu";
...
const clearBreedingDate = () => {
  drawerProps.value.row.propagation_date = ""; // 清空批次关联日期
};
